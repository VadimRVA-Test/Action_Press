...
class TestActionPage:
    def test_action_press_page(self, action_page, assertions):
        ...
        count_elements2 = assertions.all_index_locator(action_page.menu_advantages.collections_of_repeating_locators())
        ...
        count_elements3 = assertions.all_index_locator(action_page.collections_of_repeating_locators())
        assert (assertions.all_index_locator(action_page.collections_of_repeating_locators()) ==
                action_count), f"Ожидали количество элементов {action_count}! Получили: {count_elements3}"
