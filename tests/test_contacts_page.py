...
class TestContactPage:
    def test_contacts_page(self, action_page, contacts_page, assertions):
        ...
        count_element3 = assertions.all_index_locator(contacts_page.collections_of_repeating_locators())
        assert count_element3 == contact_count, f"Ожидали количество элементов{contact_count}!Получили:{count_element3}"
